...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let response = await fetch("https://getform.io/f/blllgdwb", {
        method: "POST",
        body: formData,
      });
      ...
      setButtonText("Send");
      setStatus({ success: false, message: 'Failed to send message. Please check your network or try again later.' });
    }
  };
